...
# masing-masing 2 data
# =========================
data = [
    # POSITIF
    ("materinya sangat bagus dan mudah dipahami", 2),
    ("platform pembelajaran ini sangat membantu dan interaktif", 2),

    # NEGATIF
    ("materinya sulit dipahami dan membingungkan", 0),
    ("platform sering error dan tidak nyaman digunakan", 0),

    # NETRAL
    ("materinya cukup baik namun masih bisa ditingkatkan", 1),
    ("platform berjalan normal tanpa kendala berarti", 1)
]
